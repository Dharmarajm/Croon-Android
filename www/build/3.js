...
var SettingsPage = /** @class */ (function () {
    ...
    SettingsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-settings',template:/*ion-inline-start:"/home/it/HSENGIV/CROON-ANDROID/src/pages/settings/settings.html"*/'<ion-header>\n  <ion-toolbar color="dark-blue">\n    <span>\n      <button menuToggle ion-button icon-only clear>\n        <ion-icon name="md-menu"></ion-icon>\n      </button>\n    </span>\n    <img src="assets/imgs/header-logo.png">\n    <span>\n      <button ion-button icon-only clear>\n        <ion-icon name="ios-notifications-outline"></ion-icon>\n      </button>\n    </span>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n <!--  <button ion-button icon-only clear (click)="goto_profile()">Profile</button> -->\n</ion-content>'/*ion-inline-end:"/home/it/HSENGIV/CROON-ANDROID/src/pages/settings/settings.html"*/,
        }),
